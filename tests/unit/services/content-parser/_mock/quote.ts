export const quoteTagMocks: ContentParserMock[] = [
  ...
  },
  {
    ...
    bar`,
    expected: `<span class="quote" data-author-name="Ameisenfutter"><a class="quote-header" href="https://test.potber.de/thread?TID=1268185&PID=1249841625"><p>Ameisenfutter</p></a><blockquote><b>foo</b></blockquote></span>
  ...
  },
  {
    ...
    expected: `<span class="quote" data-author-name="Ameisenfutter"><a class="quote-header" href="https://test.potber.de/thread?TID=219289&PID=1249894846"><p>Ameisenfutter</p></a><blockquote><b>
    <span class="quote" data-author-name="audax"><a class="quote-header" href="https://test.potber.de/thread?TID=219289&PID=1249894747"><p>audax</p></a><blockquote><b>
    Feature Wunsch: Pausieren von Videos wenn man weiter scrollt, bis sie nicht mehr als 30% sichtbar sind.
    </b></blockquote></span>
  ...
  },
  {
    ...
    expected: `<span class="quote" data-author-name="[DtS]theSameButcher"><a class="quote-header" href="https://test.potber.de/thread?TID=219289&PID=1249882746"><p>[DtS]theSameButcher</p></a><blockquote><b>
