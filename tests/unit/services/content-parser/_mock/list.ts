export const listTagMocks: ContentParserMock[] = [
  ...
  },
  {
    ...
    [/list]`,
    expected: `<b>3.2 Links</b>
    <ul><li><a href="https://api.potber.de" target="_blank">potber-api</a>
    </li><li><a href="https://test-api.potber.de" target="_blank">potber-api (Testumgebung)</a> - Neue Features können hier getestet werden (obacht, instabil!)
    </li><li><a href="https://github.com/spuxx1701/potber-api/blob/develop/README.md" target="_blank">Dokumentation</a>
    </li><li><a href="https://github.com/spuxx1701/potber-api/blob/develop/CHANGELOG.md" target="_blank">Changelog</a>
    </li><li><a href="https://github.com/spuxx1701/potber-api/issues" target="_blank">GitHub Issues</a> - Bugs & Feature requests
    </li><li><a href="https://github.com/spuxx1701/potber-api" target="_blank">GitHub Repository</a>
    </li><li><a href="https://hub.docker.com/repository/docker/spuxx/potber-api/general" target="_blank"> DockerHub Repository</a>
    </li></ul>`,
  },
];
